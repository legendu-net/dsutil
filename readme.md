...
```bash
pip3 install --user -U https://github.com/dclong/dsutil/releases/download/v0.69.2/dsutil-0.69.2-py3-none-any.whl
```
...
```bash
pip3 install "dsutil[cv] @ https://github.com/dclong/dsutil/releases/download/v0.69.2/dsutil-0.69.2-py3-none-any.whl"
# or
